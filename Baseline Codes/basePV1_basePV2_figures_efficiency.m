...
load('basePV1_basePV2_sensitivity_analyses_DATA.mat','a2_vec','a3_vec','R2_uncoord_cons','R3_uncoord_cons');
n2=length(a2_vec);
n3=length(a3_vec);
...
%         R3=R3_coord(iR2,iR3); %Coordinated Rotation Length Community 2
        R2=R2_uncoord_cons(iR2,iR3); %Uncoordinate Rotation Length Community 1
...
%         PV2=1e6;
        alpha2=385000; %PV2/(w_init^beta2);
%         PV3=2e6;
        alpha3=257000; %PV3/(w_init^beta3);
        ...
        gamma=5; %erosion rate (m/yr) NJ=1
...
% figure (1) %figure 5c in paper
% pcolor(a3_vec/1e3,a2_vec/1e3,N_efficiency_storage)
% shading flat
% colormap jet
% pbaspect([1 1 1])
% set(gca,'FontSize',20)
% xlabel('Baseline PV_2 ($10^3)')
% ylabel({'Nourishment Efficiencies';'Baseline PV_1 ($10^3)'})
% title('Coordination')
% c1=colorbar;

figure (2) %figure 5d in paper
pcolor(a3_vec/1e3,a2_vec/1e3,N_efficiency_storage)
shading flat
colormap jet
pbaspect([1 1 1])
